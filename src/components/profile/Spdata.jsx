    ...
    <div>
      <div className="bg-white text-green-600 font-bold w-full h-full py-4 px-3">
        ...
        <div className="relative mx-auto max-w-7xl"> 
          ...
          {/* Left Arrow - Increased size for better visibility */}
          <button 
            onClick={() => scroll('left')}
          ...
          >
            <FaChevronLeft className="text-2xl xs:text-3xl" />
          </button>
          ...
          >
            ...
            {/* START: Grouped Card 1 & 2 into a single swipable unit (for mobile/tablet) */}
            <div className="flex-shrink-0 w-full snap-center flex flex-col gap-8 lg:w-auto lg:flex-row lg:justify-start lg:gap-10">
                
                {/* Card 1: Print Registration form (Full width on mobile/tablet) */}
                <div className="card bg-green-700 text-white border-[#eef5dbb2] border-4 w-full lg:w-[68%] xl:w-[580px] h-auto">
                ...
                {/* Card 2: Check your result (Full width on mobile/tablet) */}
                <div className="card bg-[#eef5db] border-4 border-green-600 w-full lg:w-[58%] xl:w-[530px] h-auto">
                  <div className="card-body py-6 lg:py-8">
            ...
            {/* END: Grouped Card 1 & 2 */}
            
            {/* Card 3: List of payment receipts (Full Viewport Height on mobile/tablet) */}
            <div className="card bg-[#eef5db] border-4 border-green-600 flex-shrink-0 w-full lg:w-full lg:max-h-[500px] lg:h-auto md:h-[80vh] h-[80vh] snap-center">
              <div className="card-body p-4 lg:py-8 flex flex-col h-full">
                <header className='flex justify-between items-center border-b-4 border-green-600 pb-2 mb-2'>
                ...
                {/* Table container set to flex-grow to fill remaining height, enabling internal scroll */}
            ...
            {/* START: Combined Card 4 & 5 Swipable Group (This is the 3rd swipe slot) */}
          ...
          {/* Right Arrow - Increased size for better visibility */}
          <button 
          ...
          >
            <FaChevronRight className="text-2xl xs:text-3xl" />
          </button>
        </div>
